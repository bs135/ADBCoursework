...
namespace OODBDemo
{
    public partial class FormKhoa : Form
    {
        ...
        {
            if (kq.kiemtraquyenuser(FormDangnhap.loginUsename, "khoa", "add") == true)
            {
        ...
        {
            if (kq.kiemtraquyenuser(FormDangnhap.loginUsename, "khoa", "up") == true)
            {
        ...
        {
            if (kq.kiemtraquyenuser(FormDangnhap.loginUsename, "khoa", "del") == true)
            {
        ...
        {
            if (kq.kiemtraquyenuser(FormDangnhap.loginUsename, "khoa", "view") == true)
            {

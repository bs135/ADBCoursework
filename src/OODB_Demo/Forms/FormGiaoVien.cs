...
namespace OODBDemo
{
    public partial class FormGiaoVien : Form
    {
        ...
        private void frmMonHoc_Load(object sender, EventArgs e)
        {
            ...
            cmbTrinhDo.Items.Add("Thạc Sĩ");
            cmbTrinhDo.Items.Add("Tiến Sĩ");
        ...
        {
            if (kq.kiemtraquyenuser(FormDangnhap.loginUsename, "giaovien", "up") == true)
            {
                Khoa kh = _khoa.getByName(cmbKhoa.Text);
                if (kh == null)
                {
        ...
        {
            if (kq.kiemtraquyenuser(FormDangnhap.loginUsename, "giaovien", "del") == true)
            {
        ...
        {
            if (kq.kiemtraquyenuser(FormDangnhap.loginUsename, "giaovien", "view") == true)
            {
